...
export const todayIssues: SourceItem[] = [
  {
    ...
    source: "금융위원회",
    date: "2023-11-10",
    url: "https://www.fsc.go.kr/no010101/78331",
  ...
  },
  {
    ...
    source: "금융감독원",
    date: "2023-11-09",
    url: "https://www.fss.or.kr/fss/bbs/B0000188/view.do?nttId=56998&menuNo=200218",
  ...
  },
  {
    ...
    source: "한국은행",
    date: "2023-11-08",
    url: "https://www.bok.or.kr/portal/bbs/B0000328/view.do?nttId=10079221&menuNo=200726",
    summary: "한국은행 금융통화위원회는 현재 3.5%인 기준금리를 유지하기로 결정했습니다. 물가 상승세 둔화와 경기 회복 지연을 고려한 결정으로, 향후 경제 상황에 따라 금리 인하 가능성을 시사했습니다.",
...
export const fscSources: SourceItem[] = [
  ...
  {
    id: "fsc3",
    title: "2023년 제3차 금융위원회 정례회의 개최",
    source: "금융위원회",
    date: "2023-10-28",
    url: "https://www.fsc.go.kr/no010101",
    summary: "금융위원회는 2023년 제3차 정례회의를 개최하여 금융시장 안정화 방안과 가계부채 관리방안을 논의했습니다. 서민금융 지원 확대 계획도 함께 발표되었습니다.",
    tags: ["금융정책", "가계부채", "서민금융"],
    isScrapped: false,
    type: "source",
    organization: "금융위원회"
...
export const bokSources: SourceItem[] = [
  ...
  {
    id: "bok2",
    title: "2023년 3분기 국내총생산(GDP) 발표",
    source: "한국은행",
    date: "2023-10-26",
    url: "https://www.bok.or.kr/portal/bbs/P0000559/list.do?menuNo=200690",
    summary: "한국은행은 2023년 3분기 실질 국내총생산(GDP)이 전기 대비 0.6% 성장했다고 발표했습니다. 수출 증가와 소비 회복이 주요 성장 요인으로 분석되었습니다.",
    tags: ["경제성장", "GDP", "경제지표"],
    isScrapped: false,
    type: "source",
    organization: "한국은행"
...
export const newsItems: NewsItem[] = [
  ...
  {
    id: "news2",
    title: "금융소비자보호법 시행 2년, 소비자 권익 향상됐나",
    source: "뉴스포털",
    date: "2023-11-01",
    url: "https://example.com/news/23456",
    summary: "금융소비자보호법 시행 2주년을 맞아 그 성과와 한계를 분석했다. 불완전판매 감소 등 긍정적 효과가 있었으나, 복잡한 구제절차로 인한 소비자 불편이 여전히 과제로 남아있다.",
  ...
  },
  {
    ...
    source: "IT뉴스",
    date: "2023-10-28",
    url: "https://example.com/news/34567",
  ...
  },
  {
    ...
    summary: "금융감독원이 주요 은행을 대상으로 소비자보호 실태점검을 실시한다. 대출 상품 판매 과정과 민원처리 절차에 중점을 둔 이번 점검은 11월까지 진행될 예정이다.",
